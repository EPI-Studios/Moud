...
import com.meekdev.moud.core.character.ArmPose;
...
public final class PlayerMirror {
    ...
    private PlayerMirror() {}

    public static void cape(Character character, AbstractClientPlayer wearer, float partialTick) {
    ...
    public static void skinModel(Character character, AbstractClientPlayer wearer) {
    ...
    static float bedAngle(Player player) {
    ...
    static void copy(Character character, Player player) {
