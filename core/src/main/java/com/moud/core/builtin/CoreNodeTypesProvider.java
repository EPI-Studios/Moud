...
public final class CoreNodeTypesProvider implements NodeTypeProvider {
    ...
    public void register(NodeTypeRegistry registry) {
        ...
        registry.registerType(new NodeTypeDef("MeshInstance3D", "Node3D", "MeshInstance3D", "Geometry", 22, Map.ofEntries(
                ...
                Map.entry("viewmodel", new PropertyDef("viewmodel", PropertyType.BOOL, "false", "Viewmodel", "Viewmodel", 0, Map.of())),
                Map.entry("viewmodel_offset_x", new PropertyDef("viewmodel_offset_x", PropertyType.FLOAT, "0.25", "Offset X", "Viewmodel", 1, Map.of("step", "0.01"))),
                Map.entry("viewmodel_offset_y", new PropertyDef("viewmodel_offset_y", PropertyType.FLOAT, "-0.22", "Offset Y", "Viewmodel", 2, Map.of("step", "0.01"))),
                Map.entry("viewmodel_offset_z", new PropertyDef("viewmodel_offset_z", PropertyType.FLOAT, "-0.45", "Offset Z", "Viewmodel", 3, Map.of("step", "0.01"))),
                Map.entry("viewmodel_fov", new PropertyDef("viewmodel_fov", PropertyType.FLOAT, "0", "FOV (0 = inherit)", "Viewmodel", 4, Map.of("min", "0", "max", "120", "step", "1"))),
                Map.entry("script", new PropertyDef("script", PropertyType.STRING, null, "Script", "Script", 100, Map.of()))
        )));
        ...
        registry.registerType(new NodeTypeDef("Particle3D", "Node3D", "Particle3D", "Effects", 28, Map.ofEntries(
                Map.entry("x", new PropertyDef("x", PropertyType.FLOAT, "0", "X", "Transform", 0, Map.of("step", "0.1"))),
                Map.entry("y", new PropertyDef("y", PropertyType.FLOAT, "0", "Y", "Transform", 1, Map.of("step", "0.1"))),
                Map.entry("z", new PropertyDef("z", PropertyType.FLOAT, "0", "Z", "Transform", 2, Map.of("step", "0.1"))),
                Map.entry("rx", new PropertyDef("rx", PropertyType.FLOAT, "0", "Rot X", "Transform", 10, Map.of("step", "1"))),
                Map.entry("ry", new PropertyDef("ry", PropertyType.FLOAT, "0", "Rot Y", "Transform", 11, Map.of("step", "1"))),
                Map.entry("rz", new PropertyDef("rz", PropertyType.FLOAT, "0", "Rot Z", "Transform", 12, Map.of("step", "1"))),
                Map.entry("emitting", new PropertyDef("emitting", PropertyType.BOOL, "true", "Emitting", "Emitter", 0, Map.of())),
                Map.entry("rate", new PropertyDef("rate", PropertyType.FLOAT, "20", "Rate (/s)", "Emitter", 1, Map.of("min", "0", "step", "1"))),
                Map.entry("max_particles", new PropertyDef("max_particles", PropertyType.INT, "200", "Max Particles", "Emitter", 2, Map.of("min", "0", "step", "1"))),
                Map.entry("lifetime", new PropertyDef("lifetime", PropertyType.FLOAT, "1.5", "Lifetime (s)", "Emitter", 3, Map.of("min", "0.01", "step", "0.1"))),
                Map.entry("lifetime_variance", new PropertyDef("lifetime_variance", PropertyType.FLOAT, "0.3", "Lifetime Variance", "Emitter", 4, Map.of("min", "0", "step", "0.05"))),
                Map.entry("local_space", new PropertyDef("local_space", PropertyType.BOOL, "false", "Local Space", "Emitter", 5, Map.of())),
                Map.entry("velocity_x", new PropertyDef("velocity_x", PropertyType.FLOAT, "0", "Velocity X", "Motion", 0, Map.of("step", "0.1"))),
                Map.entry("velocity_y", new PropertyDef("velocity_y", PropertyType.FLOAT, "1", "Velocity Y", "Motion", 1, Map.of("step", "0.1"))),
                Map.entry("velocity_z", new PropertyDef("velocity_z", PropertyType.FLOAT, "0", "Velocity Z", "Motion", 2, Map.of("step", "0.1"))),
                Map.entry("velocity_random", new PropertyDef("velocity_random", PropertyType.FLOAT, "0.5", "Random Velocity", "Motion", 3, Map.of("min", "0", "step", "0.1"))),
                Map.entry("spread", new PropertyDef("spread", PropertyType.FLOAT, "30", "Spread (deg)", "Motion", 4, Map.of("min", "0", "max", "180", "step", "1"))),
                Map.entry("gravity", new PropertyDef("gravity", PropertyType.FLOAT, "-2.0", "Gravity", "Motion", 5, Map.of("step", "0.1"))),
                Map.entry("damping", new PropertyDef("damping", PropertyType.FLOAT, "0.0", "Damping", "Motion", 6, Map.of("min", "0", "step", "0.05"))),
                Map.entry("texture", new PropertyDef("texture", PropertyType.STRING, "moud:dynamic/white", "Texture", "Appearance", 0, Map.of("asset", "image"))),
                Map.entry("size_start", new PropertyDef("size_start", PropertyType.FLOAT, "0.3", "Size Start", "Appearance", 1, Map.of("min", "0", "step", "0.05"))),
                Map.entry("size_end", new PropertyDef("size_end", PropertyType.FLOAT, "0.0", "Size End", "Appearance", 2, Map.of("min", "0", "step", "0.05"))),
                Map.entry("color_start_r", new PropertyDef("color_start_r", PropertyType.FLOAT, "1", "Start R", "Color", 0, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("color_start_g", new PropertyDef("color_start_g", PropertyType.FLOAT, "1", "Start G", "Color", 1, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("color_start_b", new PropertyDef("color_start_b", PropertyType.FLOAT, "1", "Start B", "Color", 2, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("color_start_a", new PropertyDef("color_start_a", PropertyType.FLOAT, "1", "Start A", "Color", 3, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("color_end_r", new PropertyDef("color_end_r", PropertyType.FLOAT, "1", "End R", "Color", 10, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("color_end_g", new PropertyDef("color_end_g", PropertyType.FLOAT, "1", "End G", "Color", 11, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("color_end_b", new PropertyDef("color_end_b", PropertyType.FLOAT, "1", "End B", "Color", 12, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("color_end_a", new PropertyDef("color_end_a", PropertyType.FLOAT, "0", "End A", "Color", 13, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("size_curve", new PropertyDef("size_curve", PropertyType.CURVE, "", "Size Curve", "Color", 20, Map.of())),
                Map.entry("alpha_curve", new PropertyDef("alpha_curve", PropertyType.CURVE, "", "Alpha Curve", "Color", 21, Map.of())),
                Map.entry("soft_particles", new PropertyDef("soft_particles", PropertyType.BOOL, "false", "Soft Particles", "Appearance", 7, Map.of())),
                Map.entry("soft_fade_distance", new PropertyDef("soft_fade_distance", PropertyType.FLOAT, "0.5", "Soft Fade Dist", "Appearance", 8, Map.of("min", "0", "step", "0.05"))),
                Map.entry("distortion", new PropertyDef("distortion", PropertyType.BOOL, "false", "Heat Distortion", "Appearance", 9, Map.of())),
                Map.entry("distortion_strength", new PropertyDef("distortion_strength", PropertyType.FLOAT, "0.3", "Distortion", "Appearance", 10, Map.of("min", "0", "step", "0.01"))),
                Map.entry("inherit_velocity", new PropertyDef("inherit_velocity", PropertyType.FLOAT, "0", "Inherit Velocity", "Motion", 7, Map.of("min", "0", "max", "1", "step", "0.05"))),
                Map.entry("lod_distance", new PropertyDef("lod_distance", PropertyType.FLOAT, "32", "LOD Distance", "Performance", 0, Map.of("min", "0", "step", "1"))),
                Map.entry("lod_rate_scale", new PropertyDef("lod_rate_scale", PropertyType.FLOAT, "0.5", "LOD Rate Scale", "Performance", 1, Map.of("min", "0", "max", "1", "step", "0.05"))),
                Map.entry("lod_size_scale", new PropertyDef("lod_size_scale", PropertyType.FLOAT, "1.5", "LOD Size Scale", "Performance", 2, Map.of("min", "0.1", "step", "0.05"))),
                Map.entry("cull_radius", new PropertyDef("cull_radius", PropertyType.FLOAT, "8", "Cull Radius", "Performance", 3, Map.of("min", "0", "step", "1"))),
                Map.entry("shape_type", new PropertyDef("shape_type", PropertyType.STRING, "point", "Shape", "Shape", 0, Map.of("options", "point,sphere,box,disc,ring,cone"))),
                Map.entry("shape_size", new PropertyDef("shape_size", PropertyType.FLOAT, "0", "Size", "Shape", 1, Map.of("min", "0", "step", "0.1"))),
                Map.entry("shape_size_x", new PropertyDef("shape_size_x", PropertyType.FLOAT, "0", "Size X", "Shape", 2, Map.of("min", "0", "step", "0.1"))),
                Map.entry("shape_size_y", new PropertyDef("shape_size_y", PropertyType.FLOAT, "0", "Size Y", "Shape", 3, Map.of("min", "0", "step", "0.1"))),
                Map.entry("shape_size_z", new PropertyDef("shape_size_z", PropertyType.FLOAT, "0", "Size Z", "Shape", 4, Map.of("min", "0", "step", "0.1"))),
                Map.entry("surface_emit", new PropertyDef("surface_emit", PropertyType.BOOL, "false", "Surface Only", "Shape", 5, Map.of())),
                Map.entry("jitter_x", new PropertyDef("jitter_x", PropertyType.FLOAT, "0", "Jitter X", "Shape", 6, Map.of("min", "0", "step", "0.05"))),
                Map.entry("jitter_y", new PropertyDef("jitter_y", PropertyType.FLOAT, "0", "Jitter Y", "Shape", 7, Map.of("min", "0", "step", "0.05"))),
                Map.entry("jitter_z", new PropertyDef("jitter_z", PropertyType.FLOAT, "0", "Jitter Z", "Shape", 8, Map.of("min", "0", "step", "0.05"))),
                Map.entry("seed", new PropertyDef("seed", PropertyType.INT, "0", "Seed", "Emitter", 6, Map.of("step", "1"))),
                Map.entry("one_shot", new PropertyDef("one_shot", PropertyType.BOOL, "false", "One Shot", "Emitter", 7, Map.of())),
                Map.entry("burst_count", new PropertyDef("burst_count", PropertyType.INT, "0", "Burst Count", "Emitter", 8, Map.of("min", "0", "step", "1"))),
                Map.entry("prewarm", new PropertyDef("prewarm", PropertyType.FLOAT, "0", "Prewarm (s)", "Emitter", 9, Map.of("min", "0", "step", "0.1"))),
                Map.entry("wind_x", new PropertyDef("wind_x", PropertyType.FLOAT, "0", "Wind X", "Forces", 0, Map.of("step", "0.1"))),
                Map.entry("wind_y", new PropertyDef("wind_y", PropertyType.FLOAT, "0", "Wind Y", "Forces", 1, Map.of("step", "0.1"))),
                Map.entry("wind_z", new PropertyDef("wind_z", PropertyType.FLOAT, "0", "Wind Z", "Forces", 2, Map.of("step", "0.1"))),
                Map.entry("turbulence_strength", new PropertyDef("turbulence_strength", PropertyType.FLOAT, "0", "Turbulence", "Forces", 3, Map.of("min", "0", "step", "0.1"))),
                Map.entry("turbulence_scale", new PropertyDef("turbulence_scale", PropertyType.FLOAT, "1.0", "Turb Scale", "Forces", 4, Map.of("min", "0.01", "step", "0.05"))),
                Map.entry("turbulence_speed", new PropertyDef("turbulence_speed", PropertyType.FLOAT, "1.0", "Turb Speed", "Forces", 5, Map.of("step", "0.1"))),
                Map.entry("collision", new PropertyDef("collision", PropertyType.BOOL, "false", "World Collision", "Forces", 10, Map.of())),
                Map.entry("bounce", new PropertyDef("bounce", PropertyType.FLOAT, "0.3", "Bounce", "Forces", 11, Map.of("min", "0", "max", "1", "step", "0.05"))),
                Map.entry("collision_friction", new PropertyDef("collision_friction", PropertyType.FLOAT, "0.5", "Friction", "Forces", 12, Map.of("min", "0", "max", "1", "step", "0.05"))),
                Map.entry("rotation_start", new PropertyDef("rotation_start", PropertyType.FLOAT, "0", "Rotation", "Rotation", 0, Map.of("step", "0.05"))),
                Map.entry("rotation_variance", new PropertyDef("rotation_variance", PropertyType.FLOAT, "0", "Rot Variance", "Rotation", 1, Map.of("min", "0", "step", "0.05"))),
                Map.entry("angular_velocity", new PropertyDef("angular_velocity", PropertyType.FLOAT, "0", "Angular Vel", "Rotation", 2, Map.of("step", "0.1"))),
                Map.entry("angular_variance", new PropertyDef("angular_variance", PropertyType.FLOAT, "0", "Angular Var", "Rotation", 3, Map.of("min", "0", "step", "0.1"))),
                Map.entry("billboard_mode", new PropertyDef("billboard_mode", PropertyType.STRING, "camera", "Billboard", "Appearance", 3, Map.of("options", "camera,velocity,y_axis,world"))),
                Map.entry("stretch_scale", new PropertyDef("stretch_scale", PropertyType.FLOAT, "1.0", "Stretch", "Appearance", 4, Map.of("min", "0", "step", "0.05"))),
                Map.entry("hframes", new PropertyDef("hframes", PropertyType.INT, "1", "H Frames", "Animation", 0, Map.of("min", "1", "step", "1"))),
                Map.entry("vframes", new PropertyDef("vframes", PropertyType.INT, "1", "V Frames", "Animation", 1, Map.of("min", "1", "step", "1"))),
                Map.entry("frame_count", new PropertyDef("frame_count", PropertyType.INT, "0", "Frame Count", "Animation", 2, Map.of("min", "0", "step", "1"))),
                Map.entry("frame_fps", new PropertyDef("frame_fps", PropertyType.FLOAT, "0", "Frame FPS", "Animation", 3, Map.of("min", "0", "step", "1"))),
                Map.entry("frame_start", new PropertyDef("frame_start", PropertyType.INT, "0", "Start Frame", "Animation", 4, Map.of("min", "0", "step", "1"))),
                Map.entry("frame_random_start", new PropertyDef("frame_random_start", PropertyType.BOOL, "false", "Random Start", "Animation", 5, Map.of())),
                Map.entry("unlit", new PropertyDef("unlit", PropertyType.BOOL, "false", "Unlit", "Appearance", 5, Map.of())),
                Map.entry("additive", new PropertyDef("additive", PropertyType.BOOL, "false", "Additive", "Appearance", 6, Map.of())),
                Map.entry("sub_emit_count", new PropertyDef("sub_emit_count", PropertyType.INT, "0", "Sub Count", "Sub Emitter", 0, Map.of("min", "0", "step", "1"))),
                Map.entry("sub_emit_lifetime", new PropertyDef("sub_emit_lifetime", PropertyType.FLOAT, "0.5", "Sub Lifetime", "Sub Emitter", 1, Map.of("min", "0.01", "step", "0.05"))),
                Map.entry("sub_emit_speed", new PropertyDef("sub_emit_speed", PropertyType.FLOAT, "1.0", "Sub Speed", "Sub Emitter", 2, Map.of("min", "0", "step", "0.1"))),
                Map.entry("sub_emit_size", new PropertyDef("sub_emit_size", PropertyType.FLOAT, "0.1", "Sub Size", "Sub Emitter", 3, Map.of("min", "0", "step", "0.05"))),
                Map.entry("sub_emit_inherit_velocity", new PropertyDef("sub_emit_inherit_velocity", PropertyType.BOOL, "true", "Inherit Velocity", "Sub Emitter", 4, Map.of())),
                Map.entry("script", new PropertyDef("script", PropertyType.STRING, null, "Script", "Script", 100, Map.of()))
        )));
        ...
        registry.registerType(new NodeTypeDef("Text3D", "Node3D", "Text3D", "Geometry", 27, Map.ofEntries(
                ...
                Map.entry("color_tint_g", new PropertyDef("color_tint_g", PropertyType.FLOAT, "1", "G", "Color Tint", 1, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("color_tint_b", new PropertyDef("color_tint_b", PropertyType.FLOAT, "1", "B", "Color Tint", 2, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("font", new PropertyDef("font", PropertyType.STRING, "", "Font", "Text", 5, Map.of())),
                Map.entry("alignment", new PropertyDef("alignment", PropertyType.STRING, "center", "Alignment", "Text", 6, Map.of("options", "left,center,right"))),
                Map.entry("extrusion", new PropertyDef("extrusion", PropertyType.FLOAT, "0.0", "Extrusion", "Text", 7, Map.of("min", "0", "step", "0.01"))),
                Map.entry("opacity", new PropertyDef("opacity", PropertyType.FLOAT, "1.0", "Opacity", "Text", 8, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("letter_spacing", new PropertyDef("letter_spacing", PropertyType.FLOAT, "0.0", "Letter Spacing", "Text", 9, Map.of("step", "0.1"))),
                Map.entry("line_spacing", new PropertyDef("line_spacing", PropertyType.FLOAT, "1.0", "Line Spacing", "Text", 10, Map.of("min", "0.1", "step", "0.1"))),
                Map.entry("outline_size", new PropertyDef("outline_size", PropertyType.FLOAT, "0.0", "Outline Size", "Outline", 0, Map.of("min", "0", "step", "0.01"))),
                Map.entry("outline_color_r", new PropertyDef("outline_color_r", PropertyType.FLOAT, "0.0", "R", "Outline Color", 0, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("outline_color_g", new PropertyDef("outline_color_g", PropertyType.FLOAT, "0.0", "G", "Outline Color", 1, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("outline_color_b", new PropertyDef("outline_color_b", PropertyType.FLOAT, "0.0", "B", "Outline Color", 2, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("horizontal_anchor", new PropertyDef("horizontal_anchor", PropertyType.STRING, "center", "Horizontal Anchor", "Layout", 0, Map.of("options", "left,center,right"))),
                Map.entry("vertical_anchor", new PropertyDef("vertical_anchor", PropertyType.STRING, "center", "Vertical Anchor", "Layout", 1, Map.of("options", "top,center,baseline,bottom"))),
                Map.entry("max_width", new PropertyDef("max_width", PropertyType.FLOAT, "0.0", "Max Width", "Layout", 2, Map.of("min", "0", "step", "0.01"))),
                Map.entry("max_distance", new PropertyDef("max_distance", PropertyType.FLOAT, "0.0", "Max Distance", "Layout", 3, Map.of("min", "0", "step", "0.1"))),
                Map.entry("face_camera_mode", new PropertyDef("face_camera_mode", PropertyType.STRING, "full", "Face Camera", "Layout", 4, Map.of("options", "none,full,yaw_only"))),
                Map.entry("background", new PropertyDef("background", PropertyType.BOOL, "true", "Background", "Background", 0, Map.of())),
                Map.entry("background_opacity", new PropertyDef("background_opacity", PropertyType.FLOAT, "0.25", "Opacity", "Background", 1, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("background_color_r", new PropertyDef("background_color_r", PropertyType.FLOAT, "0.0", "R", "Background Color", 0, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("background_color_g", new PropertyDef("background_color_g", PropertyType.FLOAT, "0.0", "G", "Background Color", 1, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("background_color_b", new PropertyDef("background_color_b", PropertyType.FLOAT, "0.0", "B", "Background Color", 2, Map.of("min", "0", "max", "1", "step", "0.01"))),
                Map.entry("double_sided", new PropertyDef("double_sided", PropertyType.BOOL, "false", "Double Sided", "Render", 0, Map.of())),
                Map.entry("unlit", new PropertyDef("unlit", PropertyType.BOOL, "false", "Unlit", "Render", 1, Map.of())),
                Map.entry("script", new PropertyDef("script", PropertyType.STRING, null, "Script", "Script", 100, Map.of()))
        )));
