...
import com.meekdev.moud.script.host.data.MemoryLibrary;
...
final class Libraries {
    ...
    static void install(Host host) {
        ...
        host.api().declare(HostSignal.decl("StrikeSignal", "(position: Vector3) -> ()"));
