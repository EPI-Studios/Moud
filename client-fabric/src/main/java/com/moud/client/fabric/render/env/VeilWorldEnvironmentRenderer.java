...
public final class VeilWorldEnvironmentRenderer {
    ...
    private static void onRenderLevelStage(VeilRenderLevelStageEvent.Stage stage,
        ...
        if (stage == VeilRenderLevelStageEvent.Stage.AFTER_SKY) {
            renderSky(env, deltaTracker, camera);
        } else if (stage == VeilRenderLevelStageEvent.Stage.AFTER_WEATHER) {
            renderClouds(env, deltaTracker, camera);
        }
    }

    private static void renderSky(EnvSettings env, RenderTickCounter deltaTracker, Camera camera) {
        ...
        try {
            ...
            applyCommonUniforms(program, deltaTracker, camera);
    ...
    private static void renderClouds(EnvSettings env, RenderTickCounter deltaTracker, Camera camera) {
    ...
    private static void applyCommonUniforms(ShaderProgram program, RenderTickCounter deltaTracker, Camera camera) {
