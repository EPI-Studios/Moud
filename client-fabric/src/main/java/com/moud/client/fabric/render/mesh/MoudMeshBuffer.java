...
public final class MoudMeshBuffer {
        ...
        try {
            ...
            for (int r = 0; r <= SPHERE_RINGS; r++) {
                for (int s = 0; s <= SPHERE_SECTORS; s++) {
                    ...
                    v(verts,
                            x * 0.5f + 0.5f, y * 0.5f + 0.5f, z * 0.5f + 0.5f,
                            s * sectorStep, r * ringStep,
                            x, y, z
                    );
                }
            }
    ...
    public static int planeVbo()        {
        return planeVbo;
    }
    public static int planeEbo()        {
        return planeEbo;
    }
    public static int planeIndexCount() {
        return planeIndexCount;
    }

    public static int sphereVbo()        {
        return sphereVbo; }
    public static int sphereEbo()        {
        return sphereEbo;
    }
    public static int sphereIndexCount() {
