...
public final class VeilRenderSystem {
     ...
     */
    public static final class_4668.class_4678 BLOOM_SHARD = new class_4668.class_4678(Veil.MODID + ":bloom", VeilBloomRenderer::setupRenderState, VeilBloomRenderer::clearRenderState);
     ...
     */
    public static <T extends class_1044 & VeilPreloadedTexture> CompletableFuture<?> registerPreloadedTexture(class_2960 path, T texture) {
        return registerPreloadedTexture(path, texture, class_156.method_18349());
    }
     ...
     * @return A future for when the texture has loaded
     */
    public static <T extends class_1044 & VeilPreloadedTexture> CompletableFuture<?> registerPreloadedTexture(class_2960 path, T texture, Executor executor) {
     ...
     */
    public static @Nullable ShaderProgram setShader(class_2960 shader) {
    ...
    /**
     * Sets the shader instance to a specific instance of a shader. {@link #setShader(class_2960)} should be used in most cases.
     *
    ...
    /**
     * Sets the shader instance to a specific instance reference of a shader. {@link #setShader(class_2960)} should be used in most cases.
     *
    ...
    public static void endLastBatch(class_4597.class_4598 source, String name) {
        if (source instanceof PipelineBufferSourceAccessor accessor) {
            class_1921 renderType = accessor.getLastSharedType();
    ...
    public static void endLastBatch(class_4597.class_4598 source, class_1921 renderType) {
        if (source instanceof PipelineBufferSourceAccessor accessor) {
            class_1921 lastSharedType = accessor.getLastSharedType();
    ...
    public static void init() {
        ...
        if (!(client.method_1478() instanceof class_3304 resourceManager)) {
